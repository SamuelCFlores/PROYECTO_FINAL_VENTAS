...
Novedades v3:
  - Clase Comercio: datos del negocio (nombre, tipo, descripcion).
  - Clase GestorComercios: gestiona multiples comercios en comercios.json.
    Cada comercio guarda sus datos en datos_{id_comercio}.json.
  - SistemaVentas recibe comercio_id para saber qué archivo JSON usar.
  - reactivar_usuario() valida si el usuario ya estaba activo.
"""
