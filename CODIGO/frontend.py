...
frontend.py  v3
===============
Interfaz grafica del sistema de registro de ventas.
Novedades v3:
  - SelectorComercio: pantalla inicial para elegir o crear comercio.
  - LoginWindow: muestra nombre del comercio.
  - FrameReportes / Ventas por periodo: selector de calendario (tkcalendar con fallback).
  - FrameReportes / Ventas por periodo: mapa de calor Canvas con tooltip hover.
  - FrameReportes / Top derivados: toggle Lista / Grafica de pastel embebida.
  - FrameAnalytics: boton "Ver graficas" abre ventana interna con tabs por grafica.
  - FrameAnalytics: filtros ampliados (mes especifico, semana especifica, rango personalizado).
  - FrameUsuarios: reactivar valida si ya estaba activo y muestra mensaje claro.
  - App: titulo muestra nombre del comercio activo.
"""
